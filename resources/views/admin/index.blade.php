...
<div class="section-body">
    <div class="row">
        ...
        <div class="container" style="width: 100%; height: 80vh">
            <p class="text-center">Seleccione el tipo de Gráfico en el que desea presentar los datos.</p>
            <select class="form-control w-50 mb-3" id="chartType">
...
@push('js')
<!-- Agrega el script que crea la gráfica -->
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
<script>
  var ctx = document.getElementById('myChart').getContext('2d');
  var myChart = new Chart(ctx, {
    type: 'radar', // El tipo de gráfico por defecto es radar
    data: {
  ...
  // Agrega un evento onchange al elemento HTML
  document.getElementById('chartType').onchange = function() {
    // Actualiza el tipo de gráfico en la configuración del objeto myChart
